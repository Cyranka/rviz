...
##
my_words <- readxl::read_excel("/Users/harrocyranka/Desktop/code/most_common_words_english_for_twitter.xlsx")
...
clean.corpus <- function(corpus){
  ...
  corpus <- tm_map(corpus, removeWords, c(stopwords('en'),'lol',
                                          ...
                                          "better","help","former","since","every","views",my_words$word))
